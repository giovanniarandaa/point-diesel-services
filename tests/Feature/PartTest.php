...
test('parts can be searched by name', function () {
    ...
    $this->actingAs($user)->get(route('parts.index', ['search' => 'oil']))->assertOk();
});
...
test('parts can be searched by sku', function () {
    ...
    $this->actingAs($user)->get(route('parts.index', ['search' => 'FLT']))->assertOk();
});
...
test('parts can be filtered by low stock', function () {
    ...
    $response = $this->actingAs($user)->get(route('parts.index', ['filter' => 'low_stock']));
